...
function nxt_setup() {
	/*
		...
		* If you're building a theme based on Nxt, use a find and replace
		* to change 'nxt' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'nxt', get_template_directory() . '/languages' );
 ...
 */
function nxt_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'nxt_content_width', 640 );
}
add_action( 'after_setup_theme', 'nxt_content_width', 0 );
...
function nxt_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'nxt' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'nxt' ),
